...
class NeedsMoreInfo extends Action_1.Action {
	...
	async onTriggered(github) {
		...
		await new NeedsMoreInfoCloser_1.NeedsMoreInfoCloser(
			...
			+(0, utils_1.getRequiredInput)("closeDays"),
			+(0, utils_1.getRequiredInput)("pingDays"),
			(0, utils_1.getInput)("closeComment") || "",
			(0, utils_1.getInput)("pingComment") || "",
			((_a = (0, utils_1.getInput)("additionalTeam")) !== null &&
			_a !== void 0
				? _a
				: ""
			).split("|"),
