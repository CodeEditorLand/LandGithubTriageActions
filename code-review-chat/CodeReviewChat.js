...
exports.meetsReviewThreshold =
	exports.getTeamMemberReviews =
	exports.CodeReviewChat =
	exports.CodeReviewChatDeleter =
	exports.createPRObject =
		void 0;
...
class CodeReviewChatDeleter extends Chatter {
	constructor(
		...
		this.elevatedClient = slackElevatedUserToken
			? new web_api_1.WebClient(slackElevatedUserToken)
			: undefined;
	}
	async run() {
...
async function listAllMemberships(web) {
	...
	do {
		...
		(_b =
			groups === null || groups === void 0
				? void 0
				: groups.response_metadata) === null || _b === void 0
			? void 0
			: _b.next_cursor
	);
