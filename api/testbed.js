		...
		this.config = {
			globalLabels:
				(_a =
					config === null || config === void 0
						? void 0
						: config.globalLabels) !== null && _a !== void 0
					? _a
					: [],
			configs:
				(_b =
			...
			releasedCommits:
				(_d =
					config === null || config === void 0
						? void 0
						: config.releasedCommits) !== null && _d !== void 0
					? _d
					: [],
			queryRunner:
				(_e =
					config === null || config === void 0
						? void 0
						: config.queryRunner) !== null && _e !== void 0
					? _e
					: async function* () {
							yield [];
					  },
...
class TestbedIssue extends Testbed {
	constructor(globalConfig, issueConfig) {
		...
		issueConfig.comments =
			(_a =
				issueConfig === null || issueConfig === void 0
					? void 0
					: issueConfig.comments) !== null && _a !== void 0
				? _a
				: [];
		issueConfig.labels =
			(_b =
				issueConfig === null || issueConfig === void 0
					? void 0
					: issueConfig.labels) !== null && _b !== void 0
				? _b
				: [];
		issueConfig.issue = {
			...
			numComments:
				((_c =
					issueConfig === null || issueConfig === void 0
						? void 0
						: issueConfig.comments) === null || _c === void 0
					? void 0
					: _c.length) || 0,
			number: 1,
			open: true,
	...
	async postComment(body, author) {
		this.issueConfig.comments.push({
			author: {
				name: author !== null && author !== void 0 ? author : "bot",
			},
			body,
			id: Math.random(),
			timestamp: +new Date(),
