...
class Action {
	...
	async getToken() {
		...
		const token =
			(_a = (0, utils_1.getInput)("token")) !== null && _a !== void 0
				? _a
	...
	getRepoName() {
		var _a;
		return (_a = (0, utils_1.getInput)("repo")) !== null && _a !== void 0
			? _a
			: github_1.context.repo.repo;
	}
	getRepoOwner() {
		var _a;
		return (_a = (0, utils_1.getInput)("owner")) !== null && _a !== void 0
			? _a
			: github_1.context.repo.owner;
	}
	getIssueNumber() {
		var _a, _b, _c, _d, _e;
		const issueNumber = +((_a = (0, utils_1.getInput)("issue_number")) !==
			null && _a !== void 0
			? _a
			: 0);
		return (_d =
			(_b = issueNumber > 0 ? issueNumber : undefined) !== null &&
			_b !== void 0
				? _b
				: (_c = github_1.context.issue) === null || _c === void 0
					? void 0
					: _c.number) !== null && _d !== void 0
			? _d
			: (_e = github_1.context.payload.issue) === null || _e === void 0
				? void 0
				: _e.number;
	}
	getAssignee() {
	...
	getComment() {
		...
		if (payload) {
			comment =
				(_a = JSON.parse(payload)) === null || _a === void 0
					? void 0
					: _a.body;
		} else {
			comment =
				(_b = github_1.context.payload.comment) === null ||
				_b === void 0
					? void 0
					: _b.body;
		}
	...
	getCommentAuthor() {
		...
		if (payload) {
			author =
				(_a = JSON.parse(payload).user) === null || _a === void 0
					? void 0
					: _a.login;
		} else {
			author =
	...
	getLabel() {
		...
		if (payload) {
			...
			label =
				(_a = github_1.context.payload.label) === null || _a === void 0
					? void 0
					: _a.name;
		}
		return label;
	...
	async run() {
		...
		if (utils_2.errorLoggingIssue) {
			const errorIssue = (0, utils_2.errorLoggingIssue)(
				this.repoName,
				this.repoOwner,
			);
			if (
				this.repoName ===
					(errorIssue === null || errorIssue === void 0
						? void 0
						: errorIssue.repo) &&
				this.repoOwner === errorIssue.owner &&
				this.issue === errorIssue.issue
			) {
				return (0, utils_2.safeLog)(
		...
		try {
			...
			const event =
				(_a = (0, utils_1.getInput)("event")) !== null && _a !== void 0
					? _a
					: github_1.context.eventName;
			if (this.issue) {
				const octokit = new octokit_1.OctoKitIssue(
					token,
				...
				if (event === "issue_comment") {
					...
					const action =
						(_b = (0, utils_1.getInput)("action")) !== null &&
						_b !== void 0
							? _b
				...
				await this.onCreated(
					...
					(_e =
						(_d =
							github_1.context === null ||
							github_1.context === void 0
								? void 0
								: github_1.context.payload) === null ||
						_d === void 0
							? void 0
							: _d.sender) === null || _e === void 0
						? void 0
						: _e.login,
				);
			} else {
