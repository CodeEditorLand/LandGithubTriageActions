...
exports.readAccountsFromBlobStorage =
	exports.safeLog =
	exports.logErrorToIssue =
	exports.errorLoggingIssue =
	exports.getRateLimit =
	exports.daysAgoToHumanReadbleDate =
	exports.daysAgoToTimestamp =
	exports.isInsiderFrozen =
	exports.loadLatestRelease =
	exports.normalizeIssue =
	exports.getRequiredInput =
	exports.getInput =
		void 0;
...
const isInsiderFrozen = async () => {
	...
	return (_a = (
		await axios_1.default.get(
			`https://update.code.visualstudio.com/api/quality/insider/`,
		)
	).data) === null || _a === void 0
		? void 0
		: _a.frozen;
...
const daysAgoToTimestamp = (days) =>
	+new Date(Date.now() - days * 24 * 60 * 60 * 1000);
exports.daysAgoToTimestamp = daysAgoToTimestamp;
const daysAgoToHumanReadbleDate = (days) =>
	new Date(Date.now() - days * 24 * 60 * 60 * 1000)
		.toISOString()
		.replace(/\.\d{3}\w$/, "");
...
const getRateLimit = async (token) => {
	const usageData = (
		await (0, github_1.getOctokit)(token).rest.rateLimit.get()
	).data.resources;
	const usage = {};
	["core", "graphql", "search"].forEach(async (category) => {
		...
		if (usageData[category]) {
			usage[category] =
				1 -
				((_b =
					(_a = usageData[category]) === null || _a === void 0
						? void 0
						: _a.remaining) !== null && _b !== void 0
					? _b
					: 0) /
					((_d =
						(_c = usageData[category]) === null || _c === void 0
							? void 0
							: _c.limit) !== null && _d !== void 0
						? _d
						: 1);
		}
	});
	...
	try {
		...
		if (
			...
			return {
				repo: repoName,
				owner: repoOwner,
				issue: +(0, exports.getRequiredInput)("errorLogIssueNumber"),
			};
		} else {
			return undefined;
		}
