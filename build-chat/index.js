...
class BuildChatAction extends Action_1.Action {
	...
	async onTriggered() {
		...
		await (0, BuildChat_1.buildChat)(
			github,
			(0, utils_1.getRequiredInput)("workflow_run_url"),
			{
				slackToken,
				storageConnectionString:
					(0, utils_1.getInput)("storage_connection_string") ||
					undefined,
				notifyAuthors:
					(0, utils_1.getInput)("notify_authors") === "true",
				notificationChannel:
