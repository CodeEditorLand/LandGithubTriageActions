...
exports.rtrimSpaceAndEOL =
	exports.parseHeaderRange =
	exports.parseTestPlanItem =
	exports.TesterRole =
	exports.Platform =
		void 0;
/* eslint-disable */
...
function parseTestPlanItem(body, author) {
	...
	if (matches && matches.length) {
		throw new Error(
			`Test plan item has invalid assignments - ${
				header.substring(matches.index).split("\n")[0]
			}`
		);
	}
	return testPlanItem;
